...
const options = {
  definition: {
    ...
    tags: [
      { name: 'ADMIN', description: 'Admin / vendor-only routes' },
      { name: 'CLIENT', description: 'Client / app-user routes' },
      { name: 'BOTH', description: 'Routes available to both admin and client' },
      ...
      { name: 'Product Types', description: 'Product type management (e.g. Groundnut Oil under subcategory)' },
      ...
      { name: 'User FCM', description: 'User FCM token management endpoints' },
      { name: 'Rider Stats', description: 'Rider statistics management endpoints' },
